...
import { TestDataChild } from '@jeesite/test/api/test/dataChild';
...
export interface TestData extends BasicModel<TestData> {
  ...
  dataChildList?: TestDataChild[]; // 子表列表
}

export const testDataList = (params?: TestData | any) =>
  defHttp.get<TestData>({ url: adminPath + '/test/data/list', params });

export const testDataListData = (params?: TestData | any) =>
  defHttp.post<Page<TestData>>({ url: adminPath + '/test/data/listData', params });

export const testDataForm = (params?: TestData | any) =>
  defHttp.get<TestData>({ url: adminPath + '/test/data/form', params });

export const testDataSave = (params?: any, data?: TestData | any) =>
  defHttp.postJson<TestData>({ url: adminPath + '/test/data/save', params, data });

export const testDataDisable = (params?: TestData | any) =>
  defHttp.get<TestData>({ url: adminPath + '/test/data/disable', params });

export const testDataEnable = (params?: TestData | any) =>
  defHttp.get<TestData>({ url: adminPath + '/test/data/enable', params });

export const testDataDelete = (params?: TestData | any) =>
  defHttp.get<TestData>({ url: adminPath + '/test/data/delete', params });
